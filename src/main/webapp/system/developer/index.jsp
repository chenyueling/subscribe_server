...
<div data-options="region:'north',border:false" style="">
  <div class="header">
    <div class="hgroup">
      <strong style="font-size: 30px">Subscribe-开发者后台</strong>
    </div>
    <div class="clear"></div>
...
<div data-options="region:'west', split:'false'" style="width:240px;">
  <div class="easyui-accordion" data-options="fit:false,border:false">
    <div title="设备管理">
      <ul class="wg_menu">
        <li><a href="system/developer/device-manage.jsp">设备列表</a></li>
      </ul>
    </div>
    <div title="我的服务">
      <ul class="wg_menu">
        <li><a href="system/developer/server-manage.jsp">服务列表</a></li>
      </ul>
    </div>
    <div title="推送历史">
      <ul class="wg_menu">
        <li><a href="system/developer/article-manage.jsp">推送列表</a></li>
      </ul>
    </div>
    <div title="个人管理">
      <ul class="wg_menu">
